...
\begingroup
\let\clearpage\relax
\input{content/10_Type_of_Database}
\input{content/20_relational_reference}
\input{content/30_deployment}
\input{content/40_architecture}
\input{content/60_pro_con}
\endgroup
% \input{content/40_Umsetzung}
% \input{content/50_Ausblick}
