...
\ifDocType{T3\_3100}{%
	...
	% 	{\includegraphics[height=2cm]{resources/images/logo-trumpf}};
	% \end{tikzpicture}
}
...
\begin{center}
	...
	\vspace*{12mm}  {Vorlesung des Studienganges \department}\\
...
\begin{spacing}{1.2}
	\begin{tabbing}
		...
		\ifDocType{T3\_3100}{%
			...
			\textbf{Betreuer des Dualen Partners} \> Prof. Dr. Carmen Winter \\
		}%
		\ifDocType{T3\_3300}{%
			% DHBW Gutachter 
