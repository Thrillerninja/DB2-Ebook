...
\newcommand{\quoteStyle}{authoryear}						% Zitierstil: numeric-comp, alphabetic, ieee
...
\newcommand{\matriculationNumber}{8489365, 3838448, 8806607}			% Autormatrikelnummer
...
\newcommand{\companyName}{TRUMPF SE + Co. KG}			% Ausbildungsfirma Name
